...
namespace InAudioSystem.ReorderableList {
	...
	public static class ReorderableListGUI {
		...
		private static void InitStyles() {
            ...
            defaultTitleStyle.normal.background = EditorResources.TitleBackground;
            ...
            if (GUI.skin == EditorGUIUtility.isProSkin)
			    defaultContainerStyle.normal.background = EditorResources.ContainerBackground;
            else
                defaultContainerStyle.normal.background = EditorResources.ContainerBackgroundWhite;
